...
時系列データから卓越周波数を FFT により抽出するために作成しました。

プログラミングの専門家ではありませんが、

研究室のメンバーや将来の後輩たちが参考として使えるように、学習の過程も含めて公開しています。
...
sample_data フォルダに
周期解 / 非周期解 のサンプルデータを用意しています。

FFT が正しく動くか試したい人、練習したい人は、

まずこのサンプルデータを使ってみてください。
